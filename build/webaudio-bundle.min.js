...
WebAudio.Sound.prototype.loop=function(a){if(void 0===a)return this._source.loop;this._source.loop=a;return this};WebAudio.Sound.prototype.buffer=function(a){if(void 0===a)return this._source.buffer;this._source.buffer=a;return this};WebAudio.Sound.prototype.pannerCone=function(a,b,c){this._panner.coneInnerAngle=180*a/Math.PI;this._panner.coneOuterAngle=180*b/Math.PI;this._panner.coneOuterGain=c;return this};
WebAudio.Sound.prototype.pannerConeInnerAngle=function(a){if(void 0===a)return this._panner.coneInnerAngle/180*Math.PI;this._panner.coneInnerAngle=180*a/Math.PI;return this};WebAudio.Sound.prototype.pannerConeOuterAngle=function(a){if(void 0===a)return this._panner.coneOuterAngle/180*Math.PI;this._panner.coneOuterAngle=180*a/Math.PI;return this};WebAudio.Sound.prototype.pannerConeOuterGain=function(a){if(void 0===a)return this._panner.coneOuterGain;this._panner.coneOuterGain=a;return this};
WebAudio.Sound.prototype.amplitude=function(a){a=void 0!==a?a:2;var b=this._analyser,c=new Uint8Array(b.frequencyBinCount);b.getByteFrequencyData(c);for(var e=b=0;e<a;e++)b+=c[e];return b/(256*a-1)};WebAudio.Sound.prototype.tone=function(a,b){a=void 0!==a?a:200;b=void 0!==b?b:1;for(var c=webaudio.context().createBuffer(1,44100*b,44100),e=c.getChannelData(0),d=0;d<e.length;d++)e[d]=2*Math.sin(a*(d/c.sampleRate)*Math.PI);this.buffer(c);return this};
WebAudio.Sound.prototype.makeHistogram=function(a){var b=this._analyser,c=this._privHisto=this._privHisto||new Uint8Array(b.frequencyBinCount);b.getByteFrequencyData(c);a=Math.floor(c.length/a);for(var b=[],e=0,d=0;e<c.length;d++){for(var f=0,g=0;g<a;g++,e++)f+=c[e];b[d]=f/a}return b};WebAudio.Sound.prototype.load=function(a,b){this._loadAndDecodeSound(a,function(a){this._source.buffer=a;b&&b(this)}.bind(this),function(){console.warn("unable to load sound "+a)});return this};
WebAudio.Sound.prototype._loadAndDecodeSound=function(a,b,c){var e=this._context,d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){e.decodeAudioData(d.response,function(a){b&&b(a)},function(){c&&c()})};d.send()};
WebAudio.Flow=function(){var a,b=[],c=setTimeout(function(){c=null;a._next()},0);return a={destroy:function(){c&&clearTimeout(c)},par:function(c,d){(d||!(b[b.length-1]instanceof Array))&&b.push([]);b[b.length-1].push(c);return a},seq:function(b){return a.par(b,!0)},_next:function(c,d){for(var f=[],g=[],j=b.shift()||[],k=j.length,l=1==k,h=0;h<j.length;h++)(function(b,h){b(function(b,c){f[h]=b;g[h]=c;0==--k&&a._next(l?f[0]:f,l?g[0]:g)},c,d)})(j[h],h)}}};
WebAudio.Sound.fn.updateWithObject3d=function(a,b){console.assert(a instanceof THREE.Object3D);console.assert("number"===typeof b);a.updateMatrixWorld();this.updateWithMatrix4(a.matrixWorld,b);return this};
WebAudio.Sound.fn.updateWithMatrix4=function(a,b){console.assert(a instanceof THREE.Matrix4);console.assert("number"===typeof b);var c=(new THREE.Vector3).getPositionFromMatrix(a);this._panner.setPosition(c.x,c.y,c.z);var c=new THREE.Vector3(0,0,1),e=a.clone();e.setPosition({x:0,y:0,z:0});c.applyMatrix4(e);c.normalize();this._panner.setOrientation(c.x,c.y,c.z);void 0===this._prevPos?this._prevPos=(new THREE.Vector3).getPositionFromMatrix(a):(c=(new THREE.Vector3).getPositionFromMatrix(a),c=c.clone().sub(this._prevPos).divideScalar(b),
this._prevPos=(new THREE.Vector3).getPositionFromMatrix(a),this._panner.setVelocity(c.x,c.y,c.z))};WebAudio.Sound.fn.follow=function(a,b){b=b||tQuery.world;console.assert(!1===this.isFollowing());a instanceof tQuery.Object3D&&(console.assert(1===a.length),a=a.get(0));console.assert(a instanceof THREE.Object3D);this._followCb=function(b){this.updateWithObject3d(a,b)}.bind(this);b.loop().hook(this._followCb);return this};
WebAudio.Sound.fn.unfollow=function(){this._world.loop().unhook(this._followCb);this._followCb=null;return this};WebAudio.Sound.prototype.isFollowing=function(){return this._followCb?!0:!1};tQuery.World.registerInstance("enableWebAudio",function(){console.assert(!1===this.hasWebAudio(),"there is already a webaudio");var a=new WebAudio;a.followListener(this);tQuery.data(this,"webaudio",a);return this});
tQuery.World.registerInstance("disabledWebAudio",function(){if(!1===this.hasWebAudio())return this;tQuery.data(this,"webaudio").destroy();tQuery.removeData(this,"webaudio");return this});tQuery.World.registerInstance("getWebAudio",function(){return tQuery.data(this,"webaudio")});tQuery.World.registerInstance("hasWebAudio",function(){return tQuery.data(this,"webaudio")?!0:!1});tQuery.World.registerInstance("supportWebAudio",function(){return WebAudio.isAvailable});
tQuery.registerStatic("createSound",function(a,b){a=a||tQuery.world;return new WebAudio.Sound(a.getWebAudio(),b)});WebAudio.fn.followListener=function(a){this._$followListenerCb=function(b){this._followListenerCb(a.tCamera(),b)}.bind(this);a.loop().hook(this._$followListenerCb)};WebAudio.fn.unfollowListener=function(a){a.loop().unhook(this._$followListenerCb);this._$followListenerCb=null};
WebAudio.fn._followListenerCb=function(a,b){var c=this._ctx;console.assert(a instanceof THREE.Object3D);console.assert("number"===typeof b);a.updateMatrixWorld();var e=a.matrixWorld,d=(new THREE.Vector3).getPositionFromMatrix(e);c.listener.setPosition(d.x,d.y,d.z);d=e.clone();d.setPosition({x:0,y:0,z:0});var f=new THREE.Vector3(0,0,1);f.applyMatrix4(d);f.normalize();var g=new THREE.Vector3(0,-1,0);g.applyMatrix4(d);g.normalize();c.listener.setOrientation(f.x,f.y,f.z,g.x,g.y,g.z);void 0===this._prevPos?
this._prevPos=(new THREE.Vector3).getPositionFromMatrix(e):(d=(new THREE.Vector3).getPositionFromMatrix(e),d=d.clone().sub(this._prevPos).divideScalar(b),this._prevPos=(new THREE.Vector3).getPositionFromMatrix(e),c.listener.setVelocity(d.x,d.y,d.z))};
WebAudio=function(){console.assert(!0===WebAudio.isAvailable,"webkitAudioContext isnt available on your browser");this._ctx=new webkitAudioContext;this._muted=!1;this._volume=1;this._gainNode=this._ctx.createGainNode();this._compressor=this._ctx.createDynamicsCompressor();this._gainNode.connect(this._compressor);this._compressor.connect(this._ctx.destination);this._pageVisibilityCtor()};WebAudio.fn=WebAudio.prototype;WebAudio.prototype.destroy=function(){this._pageVisibilityDtor()};
WebAudio.isAvailable=window.webkitAudioContext?!0:!1;WebAudio.prototype.context=function(){return this._ctx};WebAudio.prototype.createSound=function(){return new WebAudio.Sound(this)};WebAudio.prototype._entryNode=function(){return this._gainNode};WebAudio.prototype.volume=function(a){if(void 0===a)return this._volume;this._volume=a;!1===this._muted&&(this._gainNode.gain.value=this._volume);return this};
WebAudio.prototype.mute=function(a){if(void 0===a)return this._muted;this._muted=a;this._gainNode.gain.value=this._muted?0:this._volume;return this};WebAudio.prototype.toggleMute=function(){this.mute()?this.mute(!1):this.mute(!0)};
WebAudio.prototype._pageVisibilityCtor=function(){this._pageVisibilityEventStr=void 0!==document.hidden?"visibilitychange":void 0!==document.mozHidden?"mozvisibilitychange":void 0!==document.msHidden?"msvisibilitychange":void 0!==document.webkitHidden?"webkitvisibilitychange":console.assert(!1,"Page Visibility API unsupported");this._pageVisibilityDocumentStr=void 0!==document.hidden?"hidden":void 0!==document.mozHidden?"mozHidden":void 0!==document.msHidden?"msHidden":void 0!==document.webkitHidden?
...
WebAudio.Sound.prototype.pannerConeInnerAngle=function(a){if(void 0===a)return this._panner.coneInnerAngle/180*Math.PI;this._panner.coneInnerAngle=180*a/Math.PI;return this};WebAudio.Sound.prototype.pannerConeOuterAngle=function(a){if(void 0===a)return this._panner.coneOuterAngle/180*Math.PI;this._panner.coneOuterAngle=180*a/Math.PI;return this};WebAudio.Sound.prototype.pannerConeOuterGain=function(a){if(void 0===a)return this._panner.coneOuterGain;this._panner.coneOuterGain=a;return this};
WebAudio.Sound.prototype.amplitude=function(a){a=void 0!==a?a:2;var b=this._analyser,c=new Uint8Array(b.frequencyBinCount);b.getByteFrequencyData(c);for(var e=b=0;e<a;e++)b+=c[e];return b/(256*a-1)};WebAudio.Sound.prototype.tone=function(a,b){a=void 0!==a?a:200;b=void 0!==b?b:1;for(var c=webaudio.context().createBuffer(1,44100*b,44100),e=c.getChannelData(0),d=0;d<e.length;d++)e[d]=2*Math.sin(a*(d/c.sampleRate)*Math.PI);this.buffer(c);return this};
WebAudio.Sound.prototype.makeHistogram=function(a){var b=this._analyser,c=this._privHisto=this._privHisto||new Uint8Array(b.frequencyBinCount);b.getByteFrequencyData(c);a=Math.floor(c.length/a);for(var b=[],e=0,d=0;e<c.length;d++){for(var f=0,g=0;g<a;g++,e++)f+=c[e];b[d]=f/a}return b};
...
WebAudio.Flow=function(){var a,b=[],c=setTimeout(function(){c=null;a._next()},0);return a={destroy:function(){c&&clearTimeout(c)},par:function(c,e){(e||!(b[b.length-1]instanceof Array))&&b.push([]);b[b.length-1].push(c);return a},seq:function(b){return a.par(b,!0)},_next:function(c,e){for(var f=[],g=[],j=b.shift()||[],k=j.length,l=1==k,h=0;h<j.length;h++)(function(b,h){b(function(b,c){f[h]=b;g[h]=c;0==--k&&a._next(l?f[0]:f,l?g[0]:g)},c,e)})(j[h],h)}}};
WebAudio.Sound.fn.updateWithObject3d=function(a,b){console.assert(a instanceof THREE.Object3D);console.assert("number"===typeof b);a.updateMatrixWorld();this.updateWithMatrix4(a.matrixWorld,b);return this};
...
WebAudio=function(){if(!1===WebAudio.isAvailable)throw this._addRequiredMessage(),Error("WebAudio API is required and not available.");try{this._ctx=new webkitAudioContext}catch(a){this._ctx=new webkitAudioContext}this._muted=!1;this._volume=1;this._gainNode=this._ctx.createGain();this._compressor=this._ctx.createDynamicsCompressor();this._gainNode.connect(this._compressor);this._compressor.connect(this._ctx.destination);this._pageVisibilityCtor()};WebAudio.fn=WebAudio.prototype;
WebAudio.prototype.destroy=function(){this._pageVisibilityDtor()};WebAudio.isAvailable=window.AudioContext?!0:!!window.webkitAudioContext;
...
WebAudio.prototype._pageVisibilityCtor=function(){this._pageVisibilityEventStr=void 0!==document.hidden?"visibilitychange":void 0!==document.mozHidden?"mozvisibilitychange":void 0!==document.msHidden?"msvisibilitychange":void 0!==document.webkitHidden?"webkitvisibilitychange":console.assert(!1,"Page Visibility API unsupported");this._pageVisibilityDocumentStr=void 0!==document.hidden?"hidden":void 0!==document.mozHidden?"mozHidden":void 0!==document.msHidden?"msHidden":void 0!==document.webkitHidden?
"webkitHidden":console.assert(!1,"Page Visibility API unsupported");this._$pageVisibilityCallback=function(){this.mute(document[this._pageVisibilityDocumentStr]?!0:!1)}.bind(this);document.addEventListener(this._pageVisibilityEventStr,this._$pageVisibilityCallback,!1)};WebAudio.prototype._pageVisibilityDtor=function(){document.removeEventListener(this._pageVisibilityEventStr,this._$pageVisibilityCallback,!1)};
WebAudio.NodeChainBuilder=function(a){console.assert(a instanceof AudioContext||a instanceof webkitAudioContext);this._context=a;this._lastNode=this._firstNode=null;this._nodes={}};WebAudio.NodeChainBuilder.create=function(a){return new WebAudio.NodeChainBuilder(a)};WebAudio.NodeChainBuilder.prototype.destroy=function(){};WebAudio.NodeChainBuilder.prototype.nodes=function(){return this._nodes};WebAudio.NodeChainBuilder.prototype.first=function(){return this._firstNode};
WebAudio.NodeChainBuilder.prototype.last=function(){return this._lastNode};WebAudio.NodeChainBuilder.prototype._addNode=function(a,b){this._lastNode&&"playbackRate"in this._lastNode&&(this._bufferSourceDst=a);null!==this._lastNode&&this._lastNode.connect(a);null===this._firstNode&&(this._firstNode=a);this._lastNode=a;for(var c in b)a[c]=b[c];return this};
WebAudio.NodeChainBuilder.prototype.cloneBufferSource=function(){console.assert(this._nodes.bufferSource,"no buffersource presents. Add one.");var a=this._nodes.bufferSource,b=this._context.createBufferSource();b.buffer=a.buffer;b.playbackRate=a.playbackRate;b.loop=a.loop;b.connect(this._bufferSourceDst);return b};WebAudio.NodeChainBuilder.prototype.bufferSource=function(a){var b=this._context.createBufferSource();this._nodes.bufferSource=b;return this._addNode(b,a)};
WebAudio.NodeChainBuilder.prototype.mediaStreamSource=function(a,b){var c=this._context.createMediaStreamSource(a);this._nodes.bufferSource=c;return this._addNode(c,b)};WebAudio.NodeChainBuilder.prototype.mediaElementSource=function(a,b){console.assert(a instanceof HTMLAudioElement||a instanceof HTMLVideoElement);var c=this._context.createMediaElementSource(a);this._nodes.bufferSource=c;return this._addNode(c,b)};
...
WebAudio.fn._followListenerCb=function(a,b){var c=this._ctx;console.assert(a instanceof THREE.Object3D);console.assert("number"===typeof b);a.updateMatrixWorld();var d=a.matrixWorld,e=(new THREE.Vector3).getPositionFromMatrix(d);c.listener.setPosition(e.x,e.y,e.z);e=d.clone();e.setPosition({x:0,y:0,z:0});var f=new THREE.Vector3(0,0,1);f.applyMatrix4(e);f.normalize();var g=new THREE.Vector3(0,-1,0);g.applyMatrix4(e);g.normalize();c.listener.setOrientation(f.x,f.y,f.z,g.x,g.y,g.z);void 0===this._prevPos?
this._prevPos=(new THREE.Vector3).getPositionFromMatrix(d):(e=(new THREE.Vector3).getPositionFromMatrix(d),d=e.clone().sub(this._prevPos).divideScalar(b),this._prevPos=e.clone(),c.listener.setVelocity(d.x,d.y,d.z))};
WebAudio=function(){if(!1===WebAudio.isAvailable)throw this._addRequiredMessage(),Error("WebAudio API is required and not available.");try{this._ctx=new AudioContext}catch(a){this._ctx=new webkitAudioContext}this._muted=!1;this._volume=1;this._gainNode=this._ctx.createGain();this._compressor=this._ctx.createDynamicsCompressor();this._gainNode.connect(this._compressor);this._compressor.connect(this._ctx.destination);this._pageVisibilityCtor()};WebAudio.fn=WebAudio.prototype;
WebAudio.prototype.destroy=function(){this._pageVisibilityDtor()};WebAudio.isAvailable=window.AudioContext?!0:!!window.webkitAudioContext;
WebAudio.prototype._addRequiredMessage=function(a){a=a||document.body;var b=document.createElement("div");b.style.fontFamily="monospace";b.style.fontSize="13px";b.style.textAlign="center";b.style.background="#eee";b.style.color="#000";b.style.padding="1em";b.style.width="475px";b.style.margin="5em auto 0";b.innerHTML='Your browser does not seem to support <a href="https://dvcs.w3.org/hg/audio/raw-file/tip/webaudio/specification.html">WebAudio API</a>.<br />\nTry with <a href="https://www.google.com/intl/en/chrome/browser/">Chrome Browser</a>.';a.appendChild(b)};
WebAudio.prototype.context=function(){return this._ctx};WebAudio.prototype.createSound=function(){return new WebAudio.Sound(this)};WebAudio.prototype._entryNode=function(){return this._gainNode};WebAudio.prototype.volume=function(a){if(void 0===a)return this._volume;this._volume=a;!1===this._muted&&(this._gainNode.gain.value=this._volume);return this};WebAudio.prototype.mute=function(a){if(void 0===a)return this._muted;this._muted=a;this._gainNode.gain.value=this._muted?0:this._volume;return this};
WebAudio.prototype.toggleMute=function(){this.mute()?this.mute(!1):this.mute(!0)};
...
WebAudio.Sound.prototype.loop=function(a){if(void 0===a)return this._source.loop;this._source.loop=a;return this};WebAudio.Sound.prototype.buffer=function(a){if(void 0===a)return this._source.buffer;this._source.buffer=a;return this};WebAudio.Sound.prototype.pannerCone=function(a,b,c){this._panner.coneInnerAngle=180*a/Math.PI;this._panner.coneOuterAngle=180*b/Math.PI;this._panner.coneOuterGain=c;return this};
WebAudio.Sound.prototype.pannerConeInnerAngle=function(a){if(void 0===a)return this._panner.coneInnerAngle/180*Math.PI;this._panner.coneInnerAngle=180*a/Math.PI;return this};WebAudio.Sound.prototype.pannerConeOuterAngle=function(a){if(void 0===a)return this._panner.coneOuterAngle/180*Math.PI;this._panner.coneOuterAngle=180*a/Math.PI;return this};WebAudio.Sound.prototype.pannerConeOuterGain=function(a){if(void 0===a)return this._panner.coneOuterGain;this._panner.coneOuterGain=a;return this};
WebAudio.Sound.prototype.amplitude=function(a){a=void 0!==a?a:2;var b=this._analyser,c=new Uint8Array(b.frequencyBinCount);b.getByteFrequencyData(c);for(var d=b=0;d<a;d++)b+=c[d];return b/(256*a-1)};WebAudio.Sound.prototype.tone=function(a,b){a=void 0!==a?a:200;b=void 0!==b?b:1;for(var c=this._webaudio.context().createBuffer(1,44100*b,44100),d=c.getChannelData(0),e=0;e<d.length;e++)d[e]=2*Math.sin(e/c.sampleRate*a*Math.PI);this.buffer(c);return this};
WebAudio.Sound.prototype.makeHistogram=function(a){var b=this._analyser,c=this._privHisto=this._privHisto||new Uint8Array(b.frequencyBinCount);b.getByteFrequencyData(c);a=Math.floor(c.length/a);for(var b=[],d=0,e=0;d<c.length;e++){for(var f=0,g=0;g<a;g++,d++)f+=c[d];b[e]=f/a}return b};
WebAudio.Sound.prototype.load=function(a,b,c){c=c||function(){console.warn("unable to load sound "+a)};this._loadAndDecodeSound(a,function(a){this._source.buffer=a;b&&b(this)}.bind(this),function(){c&&c(this)}.bind(this));return this};WebAudio.Sound.prototype._loadAndDecodeSound=function(a,b,c){var d=this._context,e=new XMLHttpRequest;e.open("GET",a,!0);e.responseType="arraybuffer";e.onload=function(){d.decodeAudioData(e.response,function(a){b&&b(a)},function(){c&&c()})};e.send()};
